...
similar_count = 0
for pairs in list_train_false_pairs :
    pair_feature_list = []
    pair_feature_id_list = []
    pair_feature_vec_list = []

    if(([pairs[0], pairs[1]] in test_true_id_pair_list) or ([pairs[1], pairs[0]] in test_true_id_pair_list)):
        similar_count += 1
...
test_true_pair_labels = [0]*len(test_true_paired_features)   # False
...
# test_true_pair_df_vec.to_csv("../../ecsTest/ecs_project/train_false_new_pairs_vec.csv", sep=',')
# test_true_pair_df.to_csv("../../ecsTest/ecs_project/train_false_new_pairs.csv", sep=',') # general info

test_true_pair_df_vec.to_pickle("../../ecsTest/ecs_project/train_false_new_pairs_vec.pkl")
test_true_pair_df.to_pickle("../../ecsTest/ecs_project/train_false_new_pairs.pkl") # general info
