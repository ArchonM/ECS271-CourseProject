...
# test_true_pair_df_vec.to_csv("../../ecsTest/ecs_project/test_true_new_pairs_vec.csv", sep=',')
# test_true_pair_df.to_csv("../../ecsTest/ecs_project/test_true_new_pairs.csv", sep=',') # general info

test_true_pair_df_vec.to_pickle("../../ecsTest/ecs_project/test_true_new_pairs_vec.pkl")
test_true_pair_df.to_pickle("../../ecsTest/ecs_project/test_true_new_pairs.pkl") # general info
